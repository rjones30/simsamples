#!/usr/bin/env python
#
# postscript.py - runs after a simsample mergehists job
...
def stageout(fpath):
   ...
   if pro.wait() != 0:
      ...
      os.unlink(stagedir + "mergehists.d/" + fpath)

# stash any output files left behind on the stage dir
pro = subprocess.Popen(["ls", stagedir + "mergehists.d"], text=True,
...
if found[0] != nexpect:
   ...
   print("  {0:4d} : {1}{2}_merged.root".format(found[0], simType, simId))
